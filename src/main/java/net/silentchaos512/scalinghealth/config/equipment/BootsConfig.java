...
public class BootsConfig {
     ...
     * @return                  an instance
     */
    public static BootsConfig init(ConfigSpecWrapper wrapper, String path, boolean includeCost, List<CommentedConfig> defaultSettings){
        ...
        BootsConfig result = new BootsConfig();

        result.equipments = Lazy.of(() -> {
            EquipmentTierMap map = new EquipmentTierMap(EquipmentSlotType.FEET);
